...
class __RegisterFormState extends State<_RegisterForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Form(
        key: _formKey,
        child: SingleChildScrollView(  // Juste au cas où clavier pousse trop
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              TextFormField(
                ...
                validator: (value) {
                  if (value == null || value.isEmpty) return 'Veuillez saisir votre prénom';
                  return null;
                },
              ),
                        ...
                        child: ElevatedButton(
                          ...
                          if (_formKey.currentState?.validate() ?? false) {
                           final success = await controller.register(
                            ...
                            if (success) {
                          Navigator.pushNamed(context, '/success_user'); // Ou autre écran
                        } else {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(content: Text(controller.error ?? 'Erreur inconnue')),
                          );
                        }
                          }
                        },
