...
Future<File> compressImage(File file) async {
  ...
  final compressedBytes = img.encodeJpg(resized, quality: 85); // qualité à 85%
  ...
  Future<void> submitQuestion({
    ...
    try {
      ...
      final response = await ApiClient.dio.post(
        '/questions', // baseUrl déjà configuré dans ApiClient
        data: formData,
        options: Options(
          headers: {
      ...
      if (response.statusCode == 201 || response.statusCode == 200) {
        ...
        print('✅ Envoi question: $question, type: $type, image: ${_imageFile!.path}');

      } else {
        print('Erreur serveur : ${response.statusCode}');
      }
    } catch (e) {
      print('Erreur lors de l\'envoi de la question : $e');
    }
  }
}
