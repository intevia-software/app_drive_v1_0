...
import 'package:app_drive_v1_0/presentation/screens/block/block_user_controller.dart';
...
class _BlockUserScreenState extends State<BlockUserScreen> {
  final validate = BlockUserController();

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Bloquer utilisateurs')),
